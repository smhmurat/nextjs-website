        ...
        <SwiperSlide>
          <div className='relative'>
            <Image
              ...
              objectFit="cover"
            />
            <div className='absolute left-0 lg:left-1/2 top-0 lg:top-1/3 lg:-translate-y-1/2 p-4 lg:p-12 rounded-lg backdrop-opacity-40 py-4'>
              <h1 className='text-primary-color font-bold text-base text-center lg:text-4xl uppercase mb-2 lg:mb-4'>Murat Hukuk & Danışmanlık</h1>
