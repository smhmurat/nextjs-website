...
const About = () => {
  return (
    <section className="text-gray-700 body-font bg-hero-pattern bg-fixed bg-center bg-cover bg-black">
      <div className="container mx-auto flex px-5 py-16 md:flex-row flex-col items-center">
        ...
        <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
          <Image className="object-cover object-center rounded opacity-0" src='/images/hero-photo.png' width={600} height={720} alt="hero" />
        </div>
      </div>
    </section>
  )
