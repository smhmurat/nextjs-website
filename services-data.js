const services = [
    {
      'icon': '/images/assets/services/ticaret.png',
      'img': '/images/assets/services-img/ticaret.jpg',
      'title': 'Ticaret ve Şirketler Hukuku',
      'subtitle': 'Danışmanlık, Kuruluş, Sözleşme',
      'desc': ['Murat Hukuk & Danışmanlık, globalleşen Dünya"da değişen ve gelişen ticari şartlara uygun olarak, Ticaret Hukuk"unun tüm bölümlerinde uyuşmazlıkların gerek yargı mercileri öncesi gerçekçi, kârlı ve kesin, gerekse yargı merciileri aracılığıyla mümkün en hızlı ve etkin çözümünde müvekkillerine hizmet vermektedir.', 'Murat Hukuk & Danışmanlık, şirketlerin personel ile arasındaki ilişkilerin düzenlenmesi, ortaklar kurulu veya yönetim kurulu kararlarının alınması ve günlük işleyiş sırasında ortaya çıkabilecek diğer tüm konularda yerli ve yabancı şirketlere danışmanlık hizmeti sunmaktadır. Murat Hukuk & Danışmanlık, joint venture sözleşmeleri, hisse devri sözleşmeleri, uluslararası ve ulusal ticari alım-satım sözleşmeleri, alacak-borç tasfiye sözleşmeleri, leasing sözleşmeleri, yönetim sözleşmeleri, tedarik sözleşmeleri, malpraktis sözleşmeleri, sponsorluk sözleşmeleri, kira sözleşmeleri, gayrimenkul satış vaadi sözleşmeleri, hukuki ve diğer müşavirlik hizmetleri sözleşmeleri, hizmet sözleşmeleri, eser sözleşmeleri ve şirketlerin ihtiyaç duyduğu diğer tüm konulardaki sözleşmelerin müvekkillerin ihtiyaçlarına uygun ve ileride ortaya çıkabilecek riskleri bertaraf edebilecek şekilde düzenlenmesini sağlamakta, bu kapsamda sözleşmelere ilişkin görüşmelerde müvekkillerini temsil etmektedir.Murat Hukuk & Danışmanlık, ayrıca günlük işleyişin sağlıklı devam edebilmesi için Şirketlerin yeniden yapılandırılması konusunda da hukuki destek sağlamakta, yerli ve yabancı şirketlerin kuruluş, infisah, birleşme/devralma ve tür değiştirme işlemleri yapmaktadır.']
    },
    {
      'icon': '/images/assets/services/is.png',
      'img': '/images/assets/services-img/is.jpg',
      'title': 'İş ve Sosyal Güvenlik Hukuku',
      'subtitle': 'İşçi-İşveren İlişkileri, Sendikalar',
      'desc': 'Murat Hukuk & Danışmanlık, Bireysel ve Toplu İş Hukuku konusunda faaliyet göstermekte olup, İşçi-İşveren ilişkilerinde mümkün olan en hızlı ve etkili çözümleri üretme konusunda maksimum özen ile çalışmaktadır.Murat Hukuk & Danışmanlık, iş sözleşmelerinin hazırlanması ve yönetilmesi, personele yapılan ödemelerin ve kullandırılan hakların hukuka uygunluğunun denetimi, sendikalar ile ilişkilerin sürdürülmesi ve şirketlerdeki süreçlerin hukuka uygun hale getirilmesi konularında hizmet vermektedir.Murat Hukuk & Danışmanlık, işe iade, kıdem tazminatı, ihbar tazminatı, kötü niyet tazminatı, fazla mesai, ücret ve izin alacağına ilişkin davalarda müvekkillerini temsil etmektedir.'
    },
    {
      'icon': '/images/assets/services/aile.png',
      'img': '/images/assets/services-img/aile.jpg',
      'title': 'Aile Hukuku',
      'subtitle': 'Boşanma, Nafaka, Velayet',
      'desc': 'Murat Hukuk & Danışmanlık, gerek Türk vatandaşları gerekse Türk vatandaşı ve yabancılar arasındaki evlenme, nişanlanma, boşanma, nafaka yükümlülükleri, velayet, eşler arasındaki mal rejimleri, hısımlık, soybağı kurulması, evlat edinme, çocuk malları, aile malları ile vesayet gibi konularda aile hukukundan doğan ihtilafların mahkeme önünde çözümünde ve taraflar arasında protokol düzenlenmesinde müvekkillerine Medeni Kanun, Hukuk Muhakemeleri Kanunu ve ilgili milletlerarası sözleşme ve kanunlarda yer alan hükümler çerçevesinde Aile Hukukunun değindiği ilişkilerin, hassasiyet gerektiren özel yapısı gereği, özel hayatın gizliliğine büyük özen ve dikkat göstererek hizmet vermektedir.'
    },
    {
      'icon': '/images/assets/services/sigorta.png',
      'img': '/images/assets/services-img/sigorta.jpg',
      'title': 'Sigorta ve Tazminat Hukuku',
      'subtitle': 'Destekten Yoksun Kalma, İş Göremezlik',
      'desc': 'Murat Hukuk & Danışmanlık, yerel, global sigorta ve reasürans şirketlerine hem hayat hem de hayat dışı branşlar dahil olmak üzere, çok çeşitli düzenleyici ve operasyonel işlemlerde Türk Sigorta Hukuku göz önünde bulundurularak danışmanlık hizmeti vermekte ve temsil etmektedir. Ayrıca sigorta ve sigorta aracılık şirketlerine menfaatleri doğrultusunda, üçüncü şahıslara karşı rücu talepleri dahil olmak üzere, ferdi veya trafik kaza sigortası poliçeleri ile bağlantılı veya bunlardan kaynaklanan her türlü ihtilafla ilgili temsil hizmeti sunmaktadır.Murat Hukuk & Danışmanlık, edindiği deneyim ve bilgiler çerçevesinde ölümlü/yaralamalı trafik kazası sonucu maddi-manevi tazminat davaları, hayat ve maluliyet sigortası davaları, yangın sigortası davaları, kasko, havacılık ve deniz sigortası uyuşmazlıkları, ferdi kazalara ilişkin davalarda müvekkillerimize en etkili sonucu sağlamak için hukuki destek vermektedir.'
    },
    {
      'icon': '/images/assets/services/icra.png',
      'img': '/images/assets/services-img/icra.jpg',
      'title': 'İcra ve İflas Hukuku',
      'subtitle': 'İcra Takibi, Borca İtiraz, Alacağın Tahsili',
      'desc': 'Murat Hukuk & Danışmanlık, müvekkillerin alacağının tahsili amaçlı icra takiplerinde borçluya ait tüm menkul, gayrimenkul ile üçüncü kişilerdeki hak ve alacakların tespiti amaçlı kapsamlı araştırmalar yapılmakta, bu alandaki hizmetler, alacaklı/borçlu ve üçüncü kişiler arasındaki uyuşmazlıkların çözümü için icra mahkemeleri ve genel mahkemelerde dava takibi işleri yürütülmektedir.'
    },
    {
      'icon': '/images/assets/services/tuketici.png',
      'img': '/images/assets/services-img/tuketici.jpg',
      'title': 'Tüketici Hukuku',
      'subtitle': 'Alım-Satım, Ayıplı Mal, İade-Değişim',
      'desc': 'Murat Hukuk & Danışmanlık, üretimin gelişmesi ve satış tekniklerinin günden güne yenilenmesi ile satan ve satın alan arasında Tüketici Hakem Heyeti ve Tüketici Mahkemelerinde oluşabilecek ihtilaflı hususların, Tüketicinin Korunması Hakkında Kanun, Borçlar Kanunu, Ticaret Kanunu ve ilgili mevzuat hükümleri ışığında çözümü için maksimum fayda ile hizmet vermektedir. '
    },
    {
      'icon': '/images/assets/services/gayrimenkul.png',
      'img': '/images/assets/services-img/gayrimenkul.jpg',
      'title': 'Gayrimenkul ve Kira Hukuku',
      'subtitle': 'Tapu Tescil-İptal, İpotek, Kira-Tahliye',
    ...
    {
      'icon': '/images/assets/services/saglik.png',
      'img': '/images/assets/services-img/saglik.jpg',
      'title': 'Sağlık Hukuku',
      'subtitle': 'Tıbbi hata, yanlış tedavi, malpraktis',
      'desc': 'Murat Hukuk & Danışmanlık, sağlık hukukunun her alanında faaliyet göstererek gerek hatalı tıbbi müdahale nedeniyle hak aramak isteyen bireylere gerekse haksız yere hukuki ve cezai takibat altında olan sağlık mesleği mensuplarına hukuki danışmanlık vermektedir. Bu kapsamdaki faaliyet alanlarımız arasında; sağlık mesleği mensuplarına bireysel danışmanlık vermek, sağlık kuruluşlarında sunum gerçekleştirerek hekimlerin hak ve yükümlülüklerini anlatmak ve sağlık mesleği mensuplarına karşı halihazırda açılan davalarda davalı vekili veya müdafi sıfatıyla yargı makamları nezdinde savunmalarını gerçekleştirmek vardır.Öte yandan tıbbi malpraktis (tıbbi hata, doktor hatası, hatalı tıbbi uygulama, yanlış teşhis, yanlış tedavi, hatalı cerrahi müdahale, yanlış ilaç yazılması vb.) nedeniyle gerek maddi gerek manevi açıdan mağdur olarak hak aramak isteyen bireylere de sağlık hukuku kapsamında danışmanlık vermekteyiz.'
    },
    {
    ...
    {
      'icon': '/images/assets/services/ihale.png',
      'img': '/images/assets/services-img/ihale.jpg',
      'title': 'İhale Hukuku',
      'subtitle': 'İhaleye hazırlık, İptal Davası',
      'desc': 'Murat Hukuk & Danışmanlık, ihale evraklarının hazırlanması süreci de dahil olmak üzere, ihaleye iştirak edilmesi, ihale sonrası gerçekleştirilecek işlemlerin takibi ile birlikte idari otoriteler ile sözleşmelerin imzalanması süreçlerinde müvekkillerine hukuki danışmanlık hizmetleri sunmaktadır.  Ayrıca, ihale sonrası imzalanan sözleşmelerin devamı sürecinde ortaya çıkabilecek uyuşmazlıkların yargı mercileri nezdinde çözümlenmesi için davaların açılması ve takibi sürecinde de hukuki destek sağlamaktadır.'
    },
    {
      'icon': '/images/assets/services/mulkiyet.png',
      'img': '/images/assets/services-img/mulkiyet.jpg',
      'title': 'Fikri Mülkiyet Hukuku',
      'subtitle': 'Marka, Patent, Telif Hakkı',
      'desc': 'Globalleşen dünyada uluslararası ticaretin hızla yaygınlaşması, yerli ve yabancı firmaların kendilerine ait ürünlerin ve hizmetlerin ayırt edici karakteristik yönlerini koruması, marka, coğrafi işaret, tasarım, patent, faydalı model ile geleneksel ürün adlarına ilişkin hakların korunması gerekliliğini artırmıştır. Bu bağlamda Hukuk Büromuz, fikri mülkiyet hukukuna ilişkin hakların korunması, her türlü tescilin yapılması ile hukuka aykırı ve haksız tescillerin iptali ve hükümsüzlüğü, fikri mülkiyet haklarına ilişkin ihlallerin önlenmesi davaları, ihtiyati tedbir alınması, iltibas, haksız rekabet davaları gibi fikri mülkiyet alanına ilişkin her türlü davaların ve ihtilafların yürütülmesinde müvekkillerine hizmet vermektedir.'
    },
    {
      'icon': '/images/assets/services/yabanci.png',
      'img': '/images/assets/services-img/yabanci.jpg',
      'title': 'Yabancılar ve Vatandaşlık Hukuku',
      'subtitle': 'Tanıma, Tenfiz, Oturma İzni',
      'desc': 'Uluslararası ekonomik göçün makro dinamiklerinin belirlendiği son çeyrek asırda göç veren ülke konumundan göç alan ülke konumuna geçmekte olan Türkiye gibi bir ülkede faaliyet göstermekte olan Hukuk Büromuz, donanımlı Avukat ve Yabancı Danışmalarımız aracılığıyla Yabancılar Hukuku alanında bilfiil hukuki danışmanlık hizmeti vermektedir.Yabancı ülke vatandaşlarının çalışma izinlerinin alınması, oturma izni prosedürlerinin takip edilmesi, Türk Vatandaşlığına ilişkin başvuru ve takip işlemlerinin yapılması başta olmak üzere yabancılık unsuru taşıyan her konuda hukuki danışmanlık hizmeti verilmekte ve müvekkillerimizin bu alana ilişkin tüm hukuksal sorunlarına destek olup çözüm üretilmektedir.'
    },
    {
